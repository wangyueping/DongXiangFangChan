	...
	<view>
		<view class="content" @touchstart="hideDrawer">
			<scroll-view class="msg-list" scroll-y="true" :scroll-with-animation="scrollAnimation" :scroll-top="scrollTop"
			 :scroll-into-view="scrollToView" @scrolltoupper="loadHistory" upper-threshold="50" show-scrollbar="true" @tap="hideKeyboard">
				<!-- 加载历史数据waitingUI -->
				<view class="loading" v-show="historyMsgList">
	...
	export default {
		...
		methods:{
			...
			loadHistory(e){
				...
				setTimeout(()=>{
					// 消息列表
					let list = [{type:"user",msg:{id:1,type:"text",time:"12:57",userinfo:{uid:0,username:"大黑哥",face:"/static/img/face.jpg"},content:{text:"说了不买啊，滚你妈的！"}}},
					{type:"user",msg:{id:2,type:"text",time:"12:56",userinfo:{uid:1,username:"售后客服008",face:"/static/img/im/face/face_2.jpg"},content:{text:"你好，买房吗？"}}}]
					
					// 判断请求的数据是否有值
					this.historyMsgList = list.length==0?false:true
					// 获取消息中的图片,并处理显示尺寸
			...
			getMsgList(){
				...
				let list = [
					{type:"user",msg:{id:2,type:"text",time:"12:56",userinfo:{uid:1,username:"售后客服008",face:"/static/img/im/face/face_2.jpg"},content:{text:"你好，买房吗？"}}},
					{type:"user",msg:{id:1,type:"text",time:"12:57",userinfo:{uid:0,username:"大黑哥",face:"/static/img/face.jpg"},content:{text:"滚你妈的"}}},
			...
			replaceEmoji(str){
					...
					for(let i=0;i<this.emojiList.length;i++){
						...
						for(let j=0;j<row.length;j++){
							...
							if(EM.alt==item){
								...
								let imgstr = '<img style="vertical-align:middle;" src="'+onlinePath+this.onlineEmoji[EM.url]+'">';
								console.log(EM)
				...
				console.log('<div style="line-height:25px">'+replacedStr+'</div>')
