<template>
	<view>
		...
		<view class="header transparentFixed fixed" :class="{ colorWhite: isWhite }" v-if="type == 'transparentFixed'" :style="{ color: navTransparentFixedFontColor, opacity: 1 - transparentValue, zIndex: transparentValue < 0.3 ? 100 : 90 }">
			<view class="left_box">
...
<script>
	...
	export default {
		...
		methods: {
			leftClick() {
				// console.log(this)
				// console.log('我是子组件草尼玛')
				// this.$emit('clickLeftMenu', '草尼玛')
			},
...
<style lang="scss" scoped>
	...
	.header {
		...
		box-sizing: content-box;
		// padding-top: var(--status-bar-height);
		padding-top: calc(14upx + var(--status-bar-height));
		height: 88upx;
		/* #ifdef MP */
		...
		&.colorWhite {
			.left_info {
				...
				.back {
					background-image: url('../../../static/image/zhouWei-navBar/icon_back_white.png');
				}
				...
				.home {
					background-image: url('../../../static/image/zhouWei-navBar/icon_home_white.png');
				}
			}
		}
		...
		.left_info {
			...
			.back {
				background-image: url('../../../static/image/zhouWei-navBar/icon_back_black.png');
			...
			.home {
				background-image: url('../../../static/image/zhouWei-navBar/icon_home_black.png');
				background-position: center center;
				background-repeat: no-repeat;
				background-size: auto 55%;
				width: $height;
