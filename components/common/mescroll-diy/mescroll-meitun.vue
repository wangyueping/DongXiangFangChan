...
<style>
	...
	@-webkit-keyframes animProgress {
		0% {background-image: url("../../../static/image/mescroll/mescroll-progress1.png")}
		16% {background-image: url("../../../static/image/mescroll/mescroll-progress2.png")}
		32% {background-image: url("../../../static/image/mescroll/mescroll-progress3.png")}
		48% {background-image: url("../../../static/image/mescroll/mescroll-progress4.png")}
		64% {background-image: url("../../../static/image/mescroll/mescroll-progress5.png")}
		80% {background-image: url("../../../static/image/mescroll/mescroll-progress6.png")}
		100% {background-image: url("../../../static/image/mescroll/mescroll-progress1.png")}
	}
